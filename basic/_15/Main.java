...
public class Main {
    ...
    private static void exercise1() {
        ...
        while (currentInvestmentValueEuros < 100_000 && yearsPast < 5) {
    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell > 0) {
            ...
            if (poundToEuroExchangeRate > 1.15) {
                int poundsSold = Math.min(maxPoundsToSellPerDay, remainingPoundsToSell);
                remainingPoundsToSell -= poundsSold;
            }
        }
     ...
     * A1:Un ciclo do-while sarebbe più adatto poiché vogliamo dare all'utente l'opzione di eseguire un'azione almeno una volta prima di verificare se vogliono continuare.
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2:Un ciclo for each sarebbe il migliore perché iteriamo attraverso ogni utente nella lista senza sapere esplicitamente l'indice di ogni utente.
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:Un ciclo fori sarebbe il migliore perché conosciamo il numero di nomi dei clienti che vogliamo stampare e possiamo facilmente iterare attraverso di essi utilizzando il loro indice.
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4:Un ciclo while sarebbe il migliore perché vogliamo continuare a leggere fino a quando non abbiamo letto 100 righe, senza sapere quante righe ci sono in totale.
     */
}
