...
public class Main {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "(Chax)";
        String middleName = "(Madawa)";
        String lastName = "(Hewa)";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 1.5 + 'b' + true; // <--- Edit this line
    ...
    private static void exercise4() {
        ...
        System.out.println((earlyNumbers + middleNumbers.trim() + " " + endNumbers).trim()); // <--- Write your code here
    }
